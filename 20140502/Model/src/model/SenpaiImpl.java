...
public class SenpaiImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        ...
        SenpaiFullName {
            public Object get(SenpaiImpl obj) {
                return obj.getSenpaiFullName();
            }

            public void put(SenpaiImpl obj, Object value) {
                obj.setSenpaiFullName((String)value);
            }
        }
        ,
        Kohai {
    ...
    public static final int SENPAIFULLNAME = AttributesEnum.SenpaiFullName.index();
    ...
    /**
     * Gets the attribute value for SenpaiFullName, using the alias name SenpaiFullName.
     * @return the value of SenpaiFullName
     */
    public String getSenpaiFullName() {
        //return (String)getAttributeInternal(SENPAIFULLNAME);
        return getSenpaiFirstName() + " " + getSenpaiLastName() + " SAMA!!!!!!";
    }

    /**
     * Sets <code>value</code> as the attribute value for SenpaiFullName.
     * @param value value to set the SenpaiFullName
     */
    public void setSenpaiFullName(String value) {
        //setAttributeInternal(SENPAIFULLNAME, value);
    }
